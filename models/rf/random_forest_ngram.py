...
def svm_ngram(X, y):
    ...
    svm2 = Pipeline([('vect', CountVectorizer()), ('RFC', RandomForestClassifier())])
    ...
    svm3 = Pipeline([('vect', CountVectorizer(ngram_range=(1, 2))), ('RFC', RandomForestClassifier())])
    ...
    svm4 = Pipeline([('vect', CountVectorizer(ngram_range=(1, 3))), ('RFC', RandomForestClassifier())])
